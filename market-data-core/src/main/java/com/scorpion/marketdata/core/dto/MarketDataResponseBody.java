...
public class MarketDataResponseBody {
    ...
    public MarketDataResponseBody(String symbol, Double lastTradedPrice, Double bidPrice, Double midPrice, Double askPrice, Long marketTimestamp, String dependsOnSymbol, String source, LocalDate lastCouponDate, Double interestRate, Double volatility, Double accruedInterest, Double theoreticalPrice) {
        this.symbol = symbol;
